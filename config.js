window.FUNNEL_CONFIG = {
  ...
  texts: {
    /* ── Barre supérieure ── */
    topBarText:           'Livraison offerte dès 45 $ USD',
    ...
    h1Tail:               'qui révolutionne la prise en charge des jeunes athlètes',

    /* ── Intro ── */
    introP1:   'Je vois ce schéma au moins trois fois par semaine dans mon cabinet.',
    introP2:   'Un parent arrive avec son enfant de 10, 11 ou 12 ans. L\'enfant boite. Parfois en essayant de le cacher. Le parent a l\'air épuisé — pas physiquement, mais d\'une fatigue qui vient de mois passés à tout essayer sans jamais voir de résultat.',
    ...
    /* ── Section 2 ── */
    section2Title: 'Ce qui se passe réellement à l\'intérieur du talon de votre enfant (et pourquoi ce ne sont pas « de simples douleurs de croissance »)',
    section2P1:   'Voici ce qui se passe réellement à l\'intérieur du talon de votre enfant lors d\'une poussée de croissance. Je vais vous l\'expliquer comme je le fais avec les parents dans mon cabinet, parce qu\'une fois que vous comprenez le mécanisme, tout le reste — y compris pourquoi le repos et la glace continuent d\'échouer — devient évident.',
    section2P2:   'L\'os du talon de votre enfant s\'appelle le calcanéum. À l\'arrière du calcanéum se trouve un cartilage de croissance — une zone de cartilage en développement où le nouvel os se forme activement. Ce cartilage de croissance s\'appelle l\'apophyse calcanéenne.',
    section2P3:   'Le tendon d\'Achille — le tendon le plus solide du corps — s\'insère directement sur ce cartilage de croissance.',
    section2P4:   'Lors d\'une poussée de croissance, l\'os du talon s\'allonge. Il grandit. Parfois rapidement — les enfants peuvent grandir de plusieurs centimètres en quelques mois seulement.',
    ...
    section2P6:   'Ce qui se produit alors, c\'est un décalage. L\'os s\'allonge. Le tendon reste à peu près de la même longueur. Et vous vous retrouvez avec un tendon tendu attaché à un cartilage de croissance en plein développement.',
    section2P7:   'À chaque fois que votre enfant court, saute, change de direction ou pousse sur son pied, ce tendon d\'Achille tendu tire sur le cartilage de croissance encore en formation, à l\'arrière du talon.',
    section2Bold: 'C\'est ça, la maladie de Sever.',
    section2P8:   'Ce n\'est pas un bleu. Ce n\'est pas une inflammation mystérieuse. C\'est une blessure par traction mécanique — un tendon tendu qui tire sur un cartilage de croissance vulnérable, encore et encore, à chaque activité à fort impact.',
    section2P9:   'C\'est fondamentalement différent de la douleur au talon chez l\'adulte. Les adultes n\'ont pas de cartilages de croissance ouverts. Lorsque le tendon d\'Achille d\'un adulte est tendu, il tire sur un os solide et fusionné. C\'est pourquoi les solutions pour adultes — chaussettes de compression génériques, coupelles de talon standard, étirements du tendon d\'Achille — ne fonctionnent pas de la même façon chez les enfants en croissance.',
    section2Bold2: 'L\'anatomie est différente. Le problème est différent. La solution doit être différente.',
    section2P10:  'Et c\'est pour ça que le protocole standard continue d\'échouer.',
    ...
    restTitle:    'Le repos',
    restP1:       'Le repos diminue la douleur parce que votre enfant ne court pas. Moins d\'activité signifie moins de répétitions du tendon tendu qui tire sur le cartilage de croissance. L\'inflammation se calme. La douleur diminue. Tout le monde est soulagé.',
    restP2:       'Mais la poussée de croissance ne s\'arrête pas pendant le repos. L\'os continue de s\'allonger. Le tendon ne s\'allonge pas comme par magie pendant que l\'enfant est assis sur le canapé. Le décalage — la cause fondamentale du problème — est donc toujours là à la reprise de l\'entraînement.',
    restP3:       'C\'est pourquoi la douleur revient en quelques jours dès la reprise de l\'entraînement. Le repos a traité l\'irritation accumulée. Il n\'a pas modifié la tension structurelle qui en était à l\'origine.',
    restP4:       'J\'ai vu des familles traverser ce cycle quatre, cinq, six fois. À chaque repos, l\'enfant perd des semaines d\'entraînement, prend du retard sur ses coéquipiers et perd confiance. Et à chaque reprise, la douleur revient.',
    restBold:     'Le repos traite l\'effet pendant que la cause continue en dessous.',

    iceTitle:     'La glace et les anti-inflammatoires',
    iceP1:        'La glace et l\'ibuprofène réduisent l\'inflammation et les signaux de douleur. Ils soulagent le talon à court terme. Mais l\'inflammation dans la maladie de Sever n\'est pas aléatoire — elle est provoquée par la traction répétitive sur le cartilage de croissance. Réduire l\'inflammation aujourd\'hui ne fait que la voir revenir demain, parce que la contrainte mécanique n\'a pas changé.',
    iceP2:        'Des parents m\'ont dit qu\'ils donnaient de l\'ibuprofène à leur enfant avant chaque match pendant des mois. Cela m\'inquiète — non seulement pour l\'exposition au médicament, mais parce qu\'ils coupent en réalité le signal d\'alarme du corps alors que le stress sous-jacent continue.',
    ...
    orthoticsP2:  'Mais le problème principal dans la maladie de Sever n\'est pas l\'effondrement de la voûte plantaire ou l\'alignement. C\'est un tendon d\'Achille tendu qui tire sur un cartilage de croissance à l\'arrière du talon. On peut avoir des voûtes plantaires parfaites et souffrir quand même d\'une maladie de Sever sévère si l\'os du talon grandit plus vite que le tendon.',
    orthoticsP3:  'Les semelles orthopédiques sur mesure coûtent généralement entre 300 et 600 €. J\'ai vu des familles dépenser cette somme en s\'attendant à résoudre la douleur au talon, pour ne constater qu\'une amélioration minime — parce que les semelles s\'attaquaient à une biomécanique qui n\'était pas au cœur du problème.',

    ptTitle:      'La kinésithérapie et les étirements',
    ptP1:         'La kiné a de la valeur. Étirer le mollet et le tendon d\'Achille peut améliorer la souplesse avec le temps. Les exercices de renforcement renforcent la résistance.',
    ptP2:         'Mais lors d\'une poussée de croissance active, l\'os s\'allonge plus vite que les étirements ne peuvent compenser. Le kinésithérapeute essaie d\'allonger le tendon pendant que la biologie allonge activement l\'os.',
    ptBold:       'Le tendon gagne quelques millimètres de souplesse ; l\'os grandit d\'un centimètre de plus. Le calcul ne tient pas.',
    ptP3:         'C\'est pourquoi les parents rapportent que la kiné « aidait un peu, mais la douleur revenait dès la reprise de l\'entraînement à plein régime ». La thérapie faisait un vrai travail — juste pas suffisant pour compenser le rythme de croissance.',

    socksTitle:   'Les chaussettes de compression génériques',
    socksP1:      'Les parents essaient souvent des chaussettes de compression achetées sur Amazon. Certaines coûtent entre 10 et 15 €. La plupart exercent une compression uniforme sur l\'ensemble du pied et de la cheville.',
    socksP2:      'Le problème est le suivant : une compression uniforme serre tout de façon égale. Elle ne stabilise pas spécifiquement la zone où le tendon d\'Achille s\'insère dans le cartilage de croissance. Dans certains cas, une compression générale peut même augmenter la pronation — le pied qui s\'affaisse vers l\'intérieur — ce qui accroît le stress sur le talon.',
    socksP3:      'Une chaussette de compression conçue pour la récupération du mollet chez l\'adulte est un produit totalement différent de celui conçu pour stabiliser le cartilage de croissance d\'un enfant lors d\'un sport à fort impact. Les zones de compression sont différentes. Les gradients de pression sont différents. L\'anatomie ciblée est différente.',
    socksBold:    'C\'est pourquoi « on a déjà essayé les chaussettes de compression et ça n\'a pas marché » ne veut pas dire que la compression ne peut pas aider. Cela veut dire que le mauvais type de compression a été appliqué au mauvais endroit.',

    /* ── Section 4 ── */
    section4Title: 'Ce qu\'il faut vraiment faire',
    section4P1:   'Donc, si le problème est un tendon d\'Achille tendu qui tire sur un cartilage de croissance en développement pendant l\'activité — et qu\'aucun des traitements standard ne s\'attaque à cette tension pendant l\'activité — qu\'est-ce qui le fait ?',
    section4P2:   'La réponse est simple : le cartilage de croissance a besoin d\'un soutien mécanique au point précis de traction, apporté pendant l\'activité qui l\'aggrave.',
    section4P3:   'Pas un amorti par le bas. Pas une compression générale de tout le pied. Pas des étirements avant et de la glace après.',
    section4Bold: 'Une stabilisation ciblée de l\'apophyse calcanéenne — l\'endroit exact où le tendon d\'Achille s\'insère dans le cartilage de croissance — pendant la course, les sauts et les changements de direction.',
    section4P4:   'Cela réduit la force de traction sur le cartilage de croissance à chaque foulée. Ça n\'élimine pas le décalage de croissance. Ça n\'arrête pas la poussée de croissance. Mais ça réduit suffisamment le stress mécanique sur le cartilage pour que l\'irritation se résorbe pendant que l\'enfant continue à pratiquer.',
    section4Bold2: 'Le cartilage de croissance peut enfin commencer à guérir au lieu d\'être reaggravé à chaque entraînement.',
    section4P5:   'Ce n\'est pas un concept nouveau. Dans les académies sportives professionnelles pour jeunes — les programmes de développement de la MLS, les centres d\'entraînement olympiques — la stabilisation du cartilage de croissance pendant l\'activité est une pratique standard depuis des années. Aucun préparateur physique dans ces programmes ne laisserait un jeune athlète souffrant d\'apophysite calcanéenne s\'entraîner sans soutien mécanique du talon.',
    section4P6:   'Le problème, c\'est que cette approche n\'a jamais trouvé sa place dans la médecine pédiatrique courante. Les pédiatres et les médecins généralistes sont formés à raisonner en termes de maladie et de médicaments — pas en biomécanique et en soutien mécanique. Alors ils prescrivent du repos et des anti-inflammatoires. Ils traitent la maladie de Sever comme une pathologie médicale alors qu\'il s\'agit avant tout d\'un problème mécanique.',
    ...
    col1Point1:   'Oblige à arrêter le sport pendant des semaines ou des mois',
    ...
    /* ── Section 7 ── */
    section7Title: 'À quoi ressemble vraiment une évolution normale',
    timelineIntro: 'D\'après ce que j\'observe dans mon cabinet, voici à quoi la plupart des familles peuvent s\'attendre. Je veux être honnête à ce sujet, parce que je sais que vous avez déjà été déçus, et je préfère fixer des attentes réalistes plutôt que de promettre trop.',
    week1Label:    'Semaine 1 :',
    week1Text:     'L\'intensité de la douleur diminue généralement. Les parents la décrivent souvent ainsi : « Il dit toujours que ça fait mal, mais c\'est différent — plus une sensation de contracture que cette douleur lancinante. » La boiterie après l\'entraînement peut être moins prononcée. C\'est bon signe — cela signifie que le stress de traction se réduit.',
    week2Label:    'Semaine 2 :',
    ...
    t1Name:  'Jessica M.',
    t1Stars: '★★★★★',
    t1Text:  'Ma fille dit qu\'elles sont confortables, ce qui est ÉNORME parce qu\'elle détestait les coupelles qu\'on avait essayées avant. Elle les garde vraiment sans que j\'aie besoin de la relancer. On est à la semaine 3 et elle ne s\'est pas plainte une seule fois de douleur au talon depuis qu\'on a commencé.',
    t1Meta:  'Il y a 3 semaines · 👍 270',
    t2Name:  'Chris D.',
    t2Stars: '★★★★★',
    t2Text:  'La différence est flagrante. Il se réveillait en pleurant à 2h du matin et maintenant il dort toute la nuit sans problème. J\'aurais voulu trouver ça 6 mois plus tôt au lieu de dépenser des centaines d\'euros en trucs qui n\'ont servi à rien.',
    t2Meta:  'Il y a 1 semaine · 👍 185',
    t3Name:  'Sarah W.',
    t3Stars: '★★★★★',
    t3Text:  'MISE À JOUR : On les a reçues il y a 3 semaines et mon fils a disputé un tournoi complet ce week-end sans boiter. Je me suis assise dans ma voiture après et j\'ai pleuré. Si vous hésitez, essayez-les. La garantie est réelle.',
    t3Meta:  'Il y a 6 heures · 👍 94',
    t4Name:  'Michelle T.',
    t4Stars: '★★★★☆',
    t4Text:  'Il a fallu environ une semaine pour voir une vraie amélioration, mais maintenant il est revenu à la normale. Il les porte encore par précaution. La seule raison pour laquelle je mets 4 étoiles au lieu de 5, c\'est que j\'aurais aimé le savoir plus tôt pour éviter les semelles à 400 € qui prennent la poussière dans son placard.',
    t4Meta:  'Il y a 2 semaines · 👍 112',
    t5Name:  'Emily R.',
    t5Stars: '★★★★★',
    t5Text:  'Honnêtement, j\'ai cru que c\'était du vent au début. Mon mari voulait le retourner avant même que notre fils ne l\'essaie. Mais après 2 semaines, la douleur a diminué de 90 %. Il est redevenu l\'enfant qu\'on connaissait.',
    ...
    /* ── CTA final ── */
    section8Title: 'Ne laissez pas passer une autre saison',
    section8P1:    'Voici ce que je dis à chaque parent qui s\'assoit dans mon cabinet avec un enfant qui boite et une liste de choses qui n\'ont pas fonctionné :',
    ...
    bullet1:       'Leur enfant termine l\'entraînement sans boiter après',
    bullet2:       'La marche difficile du matin pour aller aux toilettes s\'arrête',
    bullet3:       'Les gémissements et les agitations nocturnes s\'estompent',
    bullet4:       'Il cesse de réclamer de la glace',
    ...
    floatStar2:        '0%',
    floatStar1:        '1%',
    floatPainLabel:    'Soulagement de la douleur',
    floatPainScore:    '★★★★★ 4,9',
    floatComfortLabel: 'Confort',
    floatComfortScore: '★★★★★ 5,0',
    floatValueLabel:   'Rapport qualité-prix',
    floatValueScore:   '★★★★★ 4,8',
    floatResultsLabel: 'Résultats',
